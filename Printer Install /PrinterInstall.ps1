...
$commandTemplate = 'msiexec /i "c:\intune\printer\6900.msi" /q DRIVERNAME="Brother MFC-L6900DW series" PRINTERNAME="{0}" ISDEFAULTPRINTER="0" IPADDRESS="{1}"'
...
if (-not $matched) {
    ...
    $pictureBox.ImageLocation = "$dirFiles\FDSLogo.ico" 

    $label = New-Object System.Windows.Forms.Label
    $label.Text = "There was an issue with adding the printer, please call support at 910-483-5395"
    $label.AutoSize = $true
