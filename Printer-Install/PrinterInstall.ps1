...
$xaml = '<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml" Title="Printer Installation" Height="300" Width="400" WindowStartupLocation="CenterScreen"><Grid><Grid.RowDefinitions><RowDefinition Height="70*"/><RowDefinition Height="*"/></Grid.RowDefinitions><Image Grid.Row="0" Source="C:\Path\To\YourCompanyLogo.png" Stretch="Fill"/><StackPanel Grid.Row="1" Margin="10"><TextBlock TextAlignment="Center" FontSize="16"><Run Text="Installing Printer..."/><LineBreak/></TextBlock><TextBlock TextAlignment="Center" FontSize="14" TextWrapping="Wrap"><Run Text="{Binding CurrentStage}"/></TextBlock><ProgressBar Grid.Row="2" Minimum="0" Maximum="100" Height="24" Foreground="Black" Background="Transparent" Margin="0,8,0,8" Value="{Binding Path=ProgressValue.Value, Converter={x:Static local:ProgressValueConverter.Value}}"/></StackPanel></Grid></Window>'
